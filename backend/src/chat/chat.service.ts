...
export class ChatService {
	...
	async getOrCreateDirectChannelForPeerSession(peerSessionId: string, userIdA: string, userIdB: string) {
	...
	async getOrCreateChannelForStudyRoom(studyRoomId: string, memberUserIds: string[]) {
		const existing = await this.prisma.channel.findFirst({
