...
export const metadata: Metadata = {
  title: "Sign Up",
  description: "Join Webyalaya for free! Create your account to start learning and teaching with peers. Connect with study rooms, share skills, and earn Webya Coins.",
  keywords: [
    "sign up",
    "register",
    "create account",
          ...
          <div className="max-w-md animate-slide-in">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span>Earn Coins by teaching others</span>
              </div>
            </div>
          </div>
        </div>
