...
// Mock skills for suggestions
const MOCK_SKILLS = [
  "React", "JavaScript", "TypeScript", "Python", "Node.js",
  "Next.js", "Vue.js", "Angular", "HTML", "CSS",
  "Design", "UI/UX", "Web Development", "Mobile Development",
  "Data Science", "Machine Learning", "GraphQL", "REST API"
];
...
export function SkillSearch({ 
  ...
  // Debounced search function with mock data
  useEffect(() => {
  ...
  const handleSearch = () => {
    ...
    setShowSuggestions(false);
    // For static build, navigation will be handled by Link
    window.location.href = `/browse?search=${encodeURIComponent(trimmedSearch)}`;
